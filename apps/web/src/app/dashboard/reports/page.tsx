  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button className="flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm shadow-emerald-600/20 transition-all hover:bg-emerald-700 active:scale-[0.98]">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "border-emerald-300 bg-emerald-50/50 ring-2 ring-emerald-400/20 dark:border-emerald-700 dark:bg-emerald-900/10"
            ...
            >
              ...
              <div>
                <p className={cn("text-sm font-semibold", isActive ? "text-emerald-700 dark:text-emerald-300" : "text-slate-900 dark:text-white")}>
                  {report.label}
                </p>
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950">
        ...
        <input
          ...
          className="h-9 rounded-lg border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/20 dark:border-slate-700 dark:bg-slate-900 dark:text-white"
        />
